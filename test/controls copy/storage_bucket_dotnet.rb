# controls/storage_bucket_python.rb
project_id = attribute("project_id", {})
function_name = attribute("function_name", {})
service_account_email = attribute("service_account_email", {})

control "storage_bucket_python" do
  title "Check Storage Bucket-triggered Python Cloud Function"
  ...
  describe google_cloudfunctions_function(project: project_id, region: "us-central1", name: function_name) do
    ...
    its("event_trigger.event_type") { should eq "google.storage.object.finalize" }
